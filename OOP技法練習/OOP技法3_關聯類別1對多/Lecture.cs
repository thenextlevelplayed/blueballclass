...
namespace OOP技法練習.OOP技法3_關聯類別1對多
{
    public class Lecture
    {
        ...
        {
            Console.WriteLine(student.getLectureAttendance());
            Console.WriteLine(student.getLectureAttendance().Contains(lectureAttendance));
            try
            {
                if (student.getLectureAttendance().Contains(lectureAttendance))
                {
        ...
        public void SignOff(Student student)
        {
            try
            {
                ...
                student.removeLectureAttendance(lectureAttendance);//雙向關聯
